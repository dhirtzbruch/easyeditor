(function ($, document, window) {
    ...
    EasyEditor.prototype.wrapSelectionWithNodeName = function (arg) {
        ...
        if (typeof arg === 'string') {
            ...
            node.attributes = arg.attributes || node.attributes;
        ...
        if (selection && selection.toString().length > 0 && selection.rangeCount) {
            ...
            if (node.style !== null || node.class !== null || node.attribute !== null || node.attributes !== null) {
                tag = _this.addAttributes(tag, node);
            }
    ...
    EasyEditor.prototype.addAttributes = function (tag, node) {
        if (node.style !== null) {
    ...
    // adding attribute in tag
    // kept / added conversion for backwards compatibility.
    EasyEditor.prototype.addAttribute = function (tag, node) {
        if (node.attribute !== null) {
            node.attributes[node.attribute[0]] = node.attribute[1];
        }

        return this.addAttributes(tag, node);
    };
